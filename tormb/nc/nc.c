...
/*
	Craft a SOCKS request for a particular
	hidden service via its onion address.
*/
...
int main(int argc, char *argv[]) {
	...
	// char *onion = "gd5n5ss65jy2cdt3.onion";
	char *onion = argv[1];	
	char *msg = argv[2];
	printf("[+] Starting nc: %s\n", onion);
...
*/
	...
	printf("[+] Server's response: %s", serverResponse);
	printf("\n");
